<?php
/**
 * Client Theme functions and definitions.
 *
...
function client_theme_setup() {
	 ...
	 * If you're building a theme based on Client Theme, use a find and replace
	 * to change 'client-theme' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'client-theme', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'client_theme_custom_background_args', array(
...
function client_theme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'client-theme' ),
		'id'            => 'sidebar-1',
...
function client_theme_scripts() {
  ...
  wp_register_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.4/jquery.min.js', array(), null, true );
	...
	wp_enqueue_script( 'app', get_template_directory_uri() . '/js/min/app.min.js', array('jquery'), null, true );

	// wp_enqueue_script( 'client-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'client-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
